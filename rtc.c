...
unsigned char  z[]={0x01,0x46,0x49,0x05,0x04,0x11,0x22};   //00sec 46min 09hr/09AM,friday,04-11-'22
/*
	For hour
...
{	   
	lcd_init();
	lcd_write('S');
//	write(0xd 0,0x00);	// To send z[i] contents to registers from 00 to 06
